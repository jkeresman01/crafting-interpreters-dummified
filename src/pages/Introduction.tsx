  ...
  return (
    <>
      ...
      <p>
        ...
        sessions is to just embrace the meaninglessness of it all, you don't fight it,
      ...
      <Callout type="note">
          <p><strong>Interesting side thought: </strong>
            ...
            concept out, the subjective reality one,  genuine look, on first walk by
            proved just that, nonetheless it did bring an <strong> interest</strong>ing
